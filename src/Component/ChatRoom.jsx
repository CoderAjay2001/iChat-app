    ...
    return (
        <div className="py-4 m-5 w-50 shadow bg-dark text-dark border rounded container" >
                <div className="text-center px-3 mb-4 text-capitalize">
                    <h1 className="text-white mb-4">{data?.room} Chat Room</h1>
                </div>
                            ...
                            <div className="row justify-content-end pl-5 ">
                                <div className="d-flex flex-column align-items-end m-2 shadow p-2 bg-success border rounded w-auto">
                                    <div>
                                        ...
                                        <small className="text-white m-1"><Moment fromNow>{msg.time}</Moment></small>
                                    </div>
                                    <h4 className=" text-white m-1">{msg.msg}</h4>
                                </div>
                            </div>
                            :
